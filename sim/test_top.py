...
async def read_mixer_values(dut):
    ...
    return {
        ...
        "m1Int":       int(dut.mx.motor1.value.to_signed()),
        "m2Int":       int(dut.mx.motor2.value.to_signed()),
        "m3Int":       int(dut.mx.motor3.value.to_signed()),
        "m4Int":       int(dut.mx.motor4.value.to_signed()),
